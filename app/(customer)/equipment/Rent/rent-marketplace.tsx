...
// Category List aligned with Foona Service sectors
const CATEGORIES = [
  "All",
  "Power Tools",
  "Cleaning",
...
const getValidImageUrl = (rawUrl: string | undefined | null) => {
  const fallbackImage =
    "https://images.unsplash.com/photo-1581141849291-1125c7b692b5?q=80&w=800"; // Reliable placeholder
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        const nearbyGear = await getNearbyEquipmentClient(
          userLat,
          userLng,
          radius,
        );
