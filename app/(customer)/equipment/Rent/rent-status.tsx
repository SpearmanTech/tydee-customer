  ...
  const handleActionPress = (action: string) => {
    ...
    switch (action) {
      case "Evidence":
        ...
        break;
      case "Contact":
        Alert.alert("Support", "Connecting you to the owner via Foona Chat...");
        break;
      case "Insurance":
        Alert.alert(
          "Insurance Policy",
          "Your 'Damage Protection' is active for this session.",
        );
        break;
      default:
      ...
      >
        ...
        <View style={styles.timerCenter}>
          ...
          <Text style={styles.timerValue}>
            02<Text style={styles.timerUnit}>d</Text> 14
            <Text style={styles.timerUnit}>h</Text> 35
      ...
      >
        ...
        <View style={styles.qrCard}>
          ...
          <Text style={styles.cardSub}>
            Present this to the owner to finalize return.
          </Text>
