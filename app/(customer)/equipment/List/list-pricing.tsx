...
export default function PremiumListStepThree() {
  ...
  // Foona's service fee logic
  const FoonaFeePercent = 0.15;
  const earnings = dailyRate
    ? (parseFloat(dailyRate) * (1 - FoonaFeePercent)).toFixed(2)
    : "0.00";
    ...
    >
          ...
          <View style={styles.surgeInsight}>
            ...
            >
              ...
              <Text style={styles.surgeText}>
                <Text style={{ fontWeight: "900" }}>High Demand!</Text> Similar
                gear is trending in Durban right now.
              </Text>
            </LinearGradient>
          </View>
        )}
      ...
      <View style={styles.footer}>
        ...
        >
          <LinearGradient
            colors={
              isComplete ? ["#10b981", "#059669"] : ["#e2e8f0", "#cbd5e1"]
            }
