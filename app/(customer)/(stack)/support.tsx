  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.headerTitle}>Foona Concierge</Text>
      ...
      >
        <Text style={styles.introText}>
          How can our elite support team assist you today?
        </Text>

        <SupportItem
          icon={<HelpCircle size={22} color="#4f46e5" />}
          title="Common Questions"
          text="Instant answers regarding bookings, payments, and Foona policies."
          bgColor="#f5f3ff"
        />
          ...
          >
            ...
            <View style={styles.urgentTextContainer}>
              ...
              <Text style={styles.urgentDesc}>
                Escalate active disputes or safety concerns immediately.
              </Text>
            </View>
          </LinearGradient>
        </TouchableOpacity>
        ...
        <View style={styles.footerNote}>
          <Text style={styles.footerNoteText}>
            Every interaction is recorded to ensure the highest standards of
            accountability in the Foona network.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
