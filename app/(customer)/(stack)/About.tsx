      ...
      >
        <View style={styles.heroSection}>
          ...
          <Text style={styles.paragraph}>
            Foona is an on-demand services marketplace designed for speed,
            accountability, and uncompromising quality. We believe that service
            excellence shouldn't be a gamble.
          </Text>
        </View>
        ...
        <Text style={styles.footerNote}>
          Foona v1.0.0 • Durban, South Africa
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
