...
import { View, Text, Animated, Image, TouchableOpacity, StyleSheet, ActivityIndicator, Platform } from 'react-native';
...
export default function ActiveJobDetails() {
  ...
  const [selectedMethod, setSelectedMethod] = useState({ id: '1', label: 'Visa ••• 0358', icon: 'card' });
      ...
      >
        ...
        <View style={styles.proSection}>
          ...
          <View style={styles.proInfo}>
            <Text style={styles.proName}>{jobData?.assigned_professional_name || "Professional"}</Text>
    ...
    <Text style={styles.pinNote}>Give this to the Pro when they arrive.</Text>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.invoiceRow}>
            ...
            <Text style={styles.invoiceValue}>R {jobData?.final_price || jobData?.price}</Text>
          </View>
          <View style={styles.invoiceRow}>
        ...
        <View style={styles.sectionCard}>
          ...
          <TouchableOpacity style={styles.methodDropdown} onPress={() => setShowPaymentModal(true)}>
             <Ionicons name={selectedMethod.icon === 'card' ? "card" : "cash"} size={20} color="#6366f1" />
          ...
          <TouchableOpacity 
            ...
            onPress={() => router.push({
              ...
              params: { jobId: jobData.id, proId: jobData.assigned_professional_id }
            })}
          >
            <LinearGradient colors={['#1f2937', '#111827']} style={styles.gradientBtn}>
